        ...
        <div className=" pb-[80px]">
            ...
            <div className="flex justify-between items-center px-4 py-3">
                <div className="flex items-center gap-2">
                    <button onClick={() => navigate('/User register')}><FaUserCircle className="text-3xl text-gray-600" /></button>
                ...
                <div className="flex items-center gap-4 text-xl">
                    ...
                    <div><button onClick={() => navigate('/notifications')}><FaBell className="text-[18px]" /></button></div>
